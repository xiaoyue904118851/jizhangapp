...
public abstract class CountBaseFragment extends BaseFragment implements RecyclerViewHolder.OnItemClickListener<PageInfo> {
...
/*        titleBar.addAction(new TitleBar.ImageAction(R.drawable.icon_action_about) {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_home_count;
    }
